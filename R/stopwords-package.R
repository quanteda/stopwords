...
#' \describe{
#' \item{[`snowball()`][data_stopwords_snowball]}{The Snowball stopword lists sources for multiple languages.
#' Most of these have been ported from the \pkg{quanteda}
#' stopword lists (in versions <1.0 of that package).}
#'
#'  \item{[`stopwords-iso()`][data_stopwords_stopwordsiso]}{The collection taken from
#'  <https://github.com/stopwords-iso/stopwords-iso/>.}
#'
#'  \item{[`smart()`][data_stopwords_smart]}{The English-language stopword list from the SMART information
#'  retrieval system.}
#'
#'  \item{[`misc()`][data_stopwords_misc]}{A few additional stopword lists, including the non-Snowball
